<script>
    ...
    onMount(async () => {
        try {
            const response = await fetch('https://survey-git-master-edasa235s-projects.vercel.app/api/questions');
            if (response.ok) {
    ...
    async function handleSubmit() {
        try {
            const response = await fetch('https://survey-git-master-edasa235s-projects.vercel.app/api/answers', {
                method: 'POST',
                headers: {
    ...
    async function handlesignup(event) {
        ...
        try {
            const response = await fetch('https://survey-git-master-edasa235s-projects.vercel.app/api/register', {
                method: 'POST',
